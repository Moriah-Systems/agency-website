          ...
          <div className="card-premium rounded-2xl overflow-hidden scroll-reveal">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-gradient-to-br from-gold/5 to-gold/10 p-8 lg:p-14 flex items-center justify-center min-h-[300px]">
                <div className="w-full rounded-xl border border-gold/10 overflow-hidden shadow-2xl">
                  <div className="flex items-center gap-2 bg-black/60 px-4 py-2.5">
                    <div className="w-3 h-3 rounded-full bg-red-500/80" />
                    <div className="w-3 h-3 rounded-full bg-yellow-500/80" />
                    <div className="w-3 h-3 rounded-full bg-green-500/80" />
                  </div>
                  <Image
                    src="/projects/dimuthu-electronics.png"
                    alt="Dimuthu Electronics website homepage"
                    width={1280}
                    height={800}
