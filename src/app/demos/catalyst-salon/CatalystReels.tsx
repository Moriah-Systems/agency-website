    ...
    <div className="relative group">
      ...
      >
        ...
        {reels.map((reel, i) => (
          ...
          >
            <div className="relative w-[260px] h-[462px] sm:w-[280px] sm:h-[498px] md:w-[300px] md:h-[534px] rounded-2xl overflow-hidden border border-[#C9A96E]/10 hover:border-[#C9A96E]/30 transition-all duration-300 hover:scale-[1.02]">
              <video
              ...
              <a
                ...
                className="absolute bottom-3 right-3 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-full p-2.5 shadow-lg transition-colors z-10"
              ...
              <div className="absolute top-3 left-3 bg-[#0A0A0A]/60 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1.5 border border-[#C9A96E]/20">
                <svg className="w-4 h-4 text-[#C9A96E]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z" />
                </svg>
                <span className="text-[#C9A96E] text-xs font-medium">Reel</span>
              </div>
            </div>
          </div>
        ))}
