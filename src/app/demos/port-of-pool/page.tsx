    ...
    <div className="min-h-screen" style={{ fontFamily: "'Inter', sans-serif", background: "#0A0A0A", color: "#F5F0EB" }}>
      ...
      <section id="booking" className="py-10 md:py-24 px-4 md:px-6" style={{ background: "#080808" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#111] border border-[#D4AF37]/10 rounded-2xl p-6 md:p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
              <div>
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Full Name</label>
                <input placeholder="Your name" className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB] placeholder:text-[#F5F0EB]/20 focus:border-[#D4AF37]/40 focus:outline-none transition" />
              </div>
              <div>
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Phone / WhatsApp</label>
                <input placeholder="07X XXX XXXX" className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB] placeholder:text-[#F5F0EB]/20 focus:border-[#D4AF37]/40 focus:outline-none transition" />
              </div>
              <div>
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Preferred Date</label>
                <input type="date" className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB]/40 focus:border-[#D4AF37]/40 focus:outline-none transition" />
              </div>
              <div>
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Time Slot</label>
                <select className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB]/40 focus:border-[#D4AF37]/40 focus:outline-none transition">
              ...
              <div className="md:col-span-2">
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Booking Type</label>
                <select className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB]/40 focus:border-[#D4AF37]/40 focus:outline-none transition">
                  <option>Select type</option>
                  <option>Per Hour (1–2 players)</option>
                  <option>Group Package (up to 6)</option>
                  <option>Tournament Entry</option>
                  <option>Private Event / Party</option>
                </select>
              </div>
              <div className="md:col-span-2">
                <label className="block text-[10px] text-[#D4AF37] tracking-widest uppercase mb-2">Notes</label>
                <textarea rows={3} placeholder="Any special requests or questions..." className="w-full px-4 py-3.5 bg-[#0A0A0A] border border-[#D4AF37]/10 rounded-lg text-sm text-[#F5F0EB] placeholder:text-[#F5F0EB]/20 focus:border-[#D4AF37]/40 focus:outline-none transition resize-none" />
              </div>
              <div className="md:col-span-2">
                <button className="w-full bg-gradient-to-r from-[#D4AF37] to-[#B8963E] text-[#0A0A0A] py-4 rounded-xl font-semibold tracking-wider uppercase hover:opacity-90 transition text-sm">
                  Confirm Booking
                </button>
              </div>
            </div>
